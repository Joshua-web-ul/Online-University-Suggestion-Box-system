...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5 bg-dark">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2023 - <?php echo $_SESSION['system']['name'] ?> | <a href="Joshua Muuo Mutisya" target="_blank">Joshua Muuo Mutisya</a></div></div>
        </footer>
